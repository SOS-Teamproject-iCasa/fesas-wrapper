...
public class FesasWrapperProperties {

	private static InputStream inputStream;
	private static FesasWrapperProperties instance;
	 ...
	 */
	private FesasWrapperProperties() {
		// intended to be empty
	}
	
	public static FesasWrapperProperties getInstance() {
		if (instance == null) {
			instance = new FesasWrapperProperties();
		}
		return instance;
	}
	...
	public void initializeProps() {
		...
		try {
			...
			String propFileName = "wrapper.properties";
